...
/**
 * SearchUtDommat represents the model behind the search form of `app\poslug\models\UtDommat`.
 */
class SearchUtDommat extends UtDommat
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['id', 'id_org', 'id_dom', 'id_tarifvid', 'id_naryad', 'id_normrab', 'proveden'], 'integer'],
            [['period', 'nom_n', 'naim', 'ed_izm'], 'safe'],
            [['kol', 'summa'], 'number'],
        ];
    }
