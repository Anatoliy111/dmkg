...
/**
 * This is the model class for table "{{%vw_obkrnow}}".
 *
 ...
 * @property float|null $dolgopl
 */
class DolgOborNow extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    public function rules()
    {
        return [
            [['kl', 'ndom'], 'integer'],
            [['period', 'fio'], 'string'],
            [['npp', 'kl_ul', 'org', 'koli_p', 'koli_pf', 'plos_bb', 'plos_ob', 'tarif', 'kl_ntar', 'tartarif', 'tarnorma', 'dolg', 'nach', 'subs', 'opl', 'uder', 'komp', 'wzmz', 'wozw', 'movw', 'pere', 'sal', 'bgst', 'prst', 'bgend', 'prend', 'fullnach', 'fullopl', 'oplnotsubs', 'dolgopl'], 'number'],
