...
//            $match = [];
        ...
        ->onText('|inf-rah#|s', function ($event) use ($bot, $botSender, $log, $apiKey,$org) {
            ...
            if ($match[0][2]==null) message($bot, $botSender, $event, $match[0][0].$match[0][1].' Інформація по рахунку '.$Rah->schet.' Виберіть потрібну функцію з меню:', getRahMenu($Rah->schet));
