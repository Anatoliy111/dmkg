        ...
        $bot
            ->onText('|.*|s', function ($event) use ($bot, $botSender, $log, $apiKey, $org, $lasdatehvd,$cli) {
                $message = <<<EOD
                                ...
                                або заново виконайте підключення до вайбербота в кабінеті споживача на сайті dmkg.com.ua (вхід за ел.поштою), і відпишіться та видаліть MyBot зі своєї Viber програми.
